...
TRAINING_SEISMIC_LABEL_ENUM = ("ai", "training_seismic_label_enum")
...
TRAINING_PRUNING_CRITERION_ENUM = ("ai", "training_pruning_criterion_enum")
TRAINING_QUANTIZE_METHOD_ENUM = ("ai", "training_quantize")
